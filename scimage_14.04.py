...
mysql-server mysql-server/root_password_again seen true
    ...
    pkgs += "ksh csh tcsh ec2-api-tools mysql-server mysql-client "
    pkgs += "nginx apache2 libapache2-mod-wsgi sysv-rc-conf pssh emacs "
    pkgs += "irssi htop vim-scripts mosh default-jdk mpich2 xvfb "
